...
- **Importing frameworks the project has not audited.** Bass's quality attributes, Ford's fitness functions, Ousterhout's deep modules, Martin's dependency rule, Nygard's ADRs are widely useful but are not this skill's governing bodies of knowledge. Adopt a format if useful, but do not apply it as authority here; if the human wants one, surface the gap first.
