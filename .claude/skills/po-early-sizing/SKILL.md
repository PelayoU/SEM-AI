...
- A risk analysis (`po-risk-analysis`) needs the size tier to apply the right escalation rule.
...
- **ISBSG as remote benchmark source** — Capers Jones BP #31, pp. 113–114 (more detail in `po-benchmarks-baselines`).
- **Growth-rate empirics (1%–3%/month, up to 50% cumulative)** — Capers Jones BP #11, p. 71.
- Full traceability: `bibliography/skill-references.md` § `po-early-sizing`.
