...
- **Retired legacy data not security-wiped.** For systems holding privileged data (financial, medical, personnel, classified), secure data destruction is part of retirement — cryptographic erasure of backups, decommissioning of credentials, revocation of certificates, audit of who held copies. Dispatch `security-officer-security-program` for the secure-disposal protocol. Leaving privileged data on retired media is a named breach vector.
