...
- **Cross-reference for high-speed FP methods (pattern matching, light FP analysis)** — Capers Jones BP #6, pp. 51–52 (depth in `product-manager-early-sizing`).
- **Benchmarks as defense for estimates** — Capers Jones BP #16, p. 80 (depth in `product-manager-cost-estimating`).
- Full traceability: `bibliography/skill-references.md` § `product-manager-benchmarks-baselines`.
