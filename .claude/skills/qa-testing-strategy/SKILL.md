...
3. **Pick the specialist / SQA-owned test set.** Start with new function + regression + system testing as the baseline. Add performance testing for systems with performance criteria; security + virus + spyware testing for internet-connected applications; usability testing for user-facing systems; scalability + platform testing for distributed systems; nationalization testing for international releases; standards testing for regulated industries.
