...
4. **Defect potentials measured by origin** — at minimum 5 categories: requirements defects, design defects, code defects, documentation defects, bad fixes (secondary bugs introduced while fixing other bugs).
