...
- **Performance, quality, and security overlap.** A high-severity bug drops performance to zero. A denial-of-service attack is a performance issue. Treating these as separate concerns produces solutions to the wrong problem.- **The human confirms.** Architect proposes; Architect does not decide.
