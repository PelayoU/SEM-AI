...
- **Do not adopt out-of-bibliography frameworks as authority.** ITIL v3/v4, Kim et al's *The Phoenix Project* / *DevOps Handbook* / Three Ways, and DORA *State of DevOps* metrics (deployment frequency / lead time / change failure rate / MTTR) are widely cited but not in audited `bibliography/sources/`. Cite Humble & Farley (the audited Continuous Delivery anchor); reference DORA / Three Ways as practitioner convention.
